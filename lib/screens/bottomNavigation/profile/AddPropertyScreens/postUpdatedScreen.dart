...
class PostUpdatedScreen extends StatefulWidget {
  const PostUpdatedScreen({super.key});

  @override
  State<PostUpdatedScreen> createState() =>
      _PostUpdatedScreenState();
}

class _PostUpdatedScreenState
    extends State<PostUpdatedScreen> {
  @override
